...
<button class='button' onclick="window.location.href='addstudent.html'">
    <div class="buttonText"><p class='h'>problem on ages</p></div>
    
    </button>
<button class='button' onclick="window.location.href='addstudent.html'">
    <div class="buttonText"><p class='h'>profit and loss</p></div>
    
    </button>
    <button class='button' onclick="window.location.href='addstudent.html'">
    <div class="buttonText"><p class='h'>simple and compound interest</p></div>
    
    </button>
    <button class='button' onclick="window.location.href='addstudent.html'">
    <div class="buttonText"><p class='h'>time and distance</p></div>
    
    </button>
    <button class='button' onclick="window.location.href='addstudent.html'">
    <div class="buttonText"><p class='h'>data interpretation</p></div>
    
    </button>
   <button class='button' onclick="window.location.href='addstudent.html'">
    <div class="buttonText"><p class='h'>progration</p></div>
