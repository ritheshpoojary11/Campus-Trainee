...
<link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    ...
    <span class="icon-button__badge">'.$count.'</span></span>
		...
		<input type="submit" class="btn" name="submit" value="Save"></div>
			</div>
...
<tr><td><h3 class="name"><i style="font-size:24px" class="fas">&#xf501;</i>&nbsp;&nbsp;Full Name</h3> </td><td><p class="name1"> <input type="text" class="na" name="name" value="'.$name.'" required></p></td></tr>

<tr><td><h3 class="name"><i style="font-size:24px" class="fas">&#xf2b6;&nbsp;</i>Email Address</h3>  </td><td><p class="name1">'.$email.'</p></td></tr>

<tr><td><h3 class="name"><i style="font-size:24px" class="fas">	&#xf87b;&nbsp;</i>Phone No</h3>  </td><td><p class="name1"><input type="text" class="na" name="phone" value='.$phone.'></p></td></tr>

<tr><td><h3 class="name"><i style="font-size:24px" class="fas">		&#xf6f1;&nbsp;</i>Address</h3>  </td><td><p class="name1"><input type="text" class="na" name="address" value="'.$address.'"></p></td></tr>

<tr><td><h3 class="name"><i style="font-size:24px" class="fas">			&#xf549;&nbsp;</i> Institution</h3>  </td><td><p class="name1"><input type="text" class="na" name="institute" value="'.$institute.'"></p></td></tr>
...
if(isset($_POST['submit']))
{
	...
	$qry="update student set name='$name',phone='$phone',address='$address',institute='$institute' where username='$username'";
	$rslt=$cn->query($qry);
	if($rslt)
	{
		echo"<script>Swal.fire({ 
                      ...
                      timer: 2000
                    }).then((result) => { window.location.href='myprofile.php?username=".$username."' })</script>";
  }
