...
<form method="POST" action="staffsend.php?staff_id='.$staff_id.'">
  ...
  <input type="submit" name="submit" class="send" value="send">
		...
		<input type="submit" class="btnx" name="submit" value="Update"></div>
			</div>
...
<tr><td>
<h3 class="name">Full Name</h3> <p class="name1"><input type="text" class="name2" name="name" value="'.$name.'" required></p></td>

<td><h3 class="name">Email Address</h3> <p class="name2">'.$email.'</p></td></tr>

<tr><td><h3 class="name">Designation</h3> <p class="name1"> <input type="text" class="name2" name="designation" value="'.$designation.'" required></p></td>

<td><h3 class="name">Department</h3> <p class="name1"><input type="text" class="name2" name="department" value='.$department.' required></p></td></tr>

<tr><td><h3 class="name">Qualification</h3> <p class="name1"><input type="text" class="name2" name="qual" value="'.$qual.'" required></p></td>

<td><h3 class="name">staff_id</h3> <p class="name2">'.$staff_id.'</p></td></tr>
...
if(isset($_POST['submit']))
{
	...
	$qry="update staff set name='$name',department='$department',designation='$designation',qual='$qual' where staff_id='$staff_id'";
	$rslt=$cn->query($qry);
	if($rslt)
	{
		echo"<script>Swal.fire({ 
                      ...
                      timer: 2000
                    }).then((result) => { window.location.href='myprofile_staff.php?staff_id=".$staff_id."' })</script>";
	}
