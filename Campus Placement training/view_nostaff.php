...
<div class="cont">
<form method="POST" action="view_nostaff.php">
...
if(isset($_POST['submit']))
{
  ...
  $search=$_POST['search'];
  $qry="SELECT * FROM `staff` WHERE concat(name,staff_id) like '%$search%'";
  $rslt1=$cn->query($qry);
  if($rslt1->num_rows>0)
  {
    while($r1=$rslt1->fetch_assoc())
    {
       echo'<div class="container">
        <P><spasn class="name">'.$r1['name'].'</span><span class="cls">'.$r1['department'].'</span><span class="regno">'.$r1['staff_id'].'</span></P>
        <div class="link">
          <a href="view_staff_fulldetail.php?staffid=.'.$r1['staff_id'].'"><i class="fa fa-eye" style="font-size:40px;color:white"></i></a>
        </div>
      </div>';
    }
...
else
{
    ...
    {
      echo'<div class="container">
        <P><span class="name">'.$r['name'].'</span><span class="cls">'.$r['department'].'</span><span class="regno">'.$r['staff_id'].'</span></P>
        <div class="link">
          <a href="view_staff_fulldetail.php?staffid='.$r['staff_id'].'"><i class="fa fa-eye" style="font-size:40px;color:white"></i></a>
        </div>
      </div>';
    }
}
