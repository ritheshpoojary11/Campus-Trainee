...
<body>
  <div class="content1">
<center> <h3 id="headi">DELETE STAFF</h3></center>
</div>
  ...
  if($rslt1->num_rows>0)
  {
    while($r1=$rslt1->fetch_assoc())
    {
       echo'<div class="container">
        <P><span class="name">'.$r1['name'].'</span><span class="cls">'.$r1['department'].'</span><span class="regno">'.$r1['staff_id'].'</span>
        <button class="dlt" onclick="dlt('.$r1['staff_id'].')"><div class="w3-padding w3-xxlarge w3-text-red"> 
...
function dlt(r1) {
    // body...
    var r2='deleted_staff.php?staffid=';
    var r3=r2.concat(r1);
    Swal.fire({
