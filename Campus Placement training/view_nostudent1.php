...
<div class="cont">
<form method="POST" action="view_nostudent1.php">
    ...
    while($r1=$rslt1->fetch_assoc())
    {
      //$regino=$r1['regino'];
       echo'<div class="container">
        ...
        <div class="link">
          <a href="view_student_fulldetail.php?regino='.$r1['regino'].'"></i><i class="fa fa-eye" style="font-size:40px;color:white"></i></a>
        </div>
      </div>';
    }
...
else
{
    while($r=$rslt->fetch_assoc())
    {
      echo'<div class="container">
        ...
        <div class="link">
          <a href="view_student_fulldetail.php?regino='.$r['regino'].'"><i class="fa fa-eye" style="font-size:40px;color:white"></i></a>
        </div>
      </div>';
    }
}
