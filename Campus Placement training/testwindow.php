...
<form method="POST" action="send.php?username='.$username.'">
  ...
  <input type="submit" name="submit" class="send" value="send">
		...
		else
		{
			...
			<tr colspan=2><td><button class="btn1" onclick=window.location.href="exam.php?username='.$username.'&&exam_id='.$exam_id.'">Take Test</button></td></tr></table><br></div>';
		}
		echo'
