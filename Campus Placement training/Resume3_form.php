...
<table style="  border-spacing: 10px; ">
  ...
  <td><p>Enter Languages</p></td><td><div id="kids">
    ...
    <tr><td colspan="2"><input type="submit" name="submit" class="btn2" align="center"></td><td colspan="1"><button class="btn3" onclick="window.location.href='student_interface.php'">Cancel</button></td></tr>
</table>
 </form>
</body>
</html>